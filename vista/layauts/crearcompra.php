              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <span id="alert_c_codigo" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_codigo_text"></span></span>
                </div>
                <div class="form-group">
                  ...
                  <span id="alert_c_fcompra" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_fcompra_text"></span></span>
                </div>
                <div class="form-group">
                  ...
                  <span id="alert_c_fventa" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_fventa_text"></span></span>
                </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <span id="alert_c_total" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_total_text"></span></span>
                </div>
                ...
                <div class="form-group">
                  ...
                  <span id="alert_c_estado" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_estado_text"></span></span>
                </div>
                <div class="form-group">
                  ...
                  <span id="alert_c_proveedodr" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_proveedodr_text"></span></span>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <span id="alert_c_producto" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_producto_text"></span></span>
                </div>
                <div class="form-group">
                  <label>Código</label>
                  <input type="text" class="form-control" placeholder="Ingrese código" id='codigo_lote_c'>
                  <span id="alert_c_codigo" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_codigo_text"></span></span>
                </div>
                <!-- text input -->
                <div class="form-group bd_rgcant">
                  ...
                  <input type="number" class="form-control" placeholder="Ingrese cantidad" id='cantidad_c'>
                  <span id="alert_c_cantidad" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_cantidad_text"></span></span>
                </div>
                <!-- text input -->
                <div class="form-group bd_rgtot">
                  <label>Precio</label>
                  <input type="number" class="form-control" placeholder="Ingrese precio" id='precio_compra_c'>
                  <span id="alert_c_precio" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_precio_text"></span></span>
                </div>
                <div class="form-group">
                  <label>Vencimiento</label>
                  <input type="date" class="form-control" id='vencimiento_c'>
                  <span id="alert_c_vencimiento" class="error invalid-feedback" style="display: none;"><i
                      class="fas fa-times-circle"></i> <span id="alert_c_vencimiento_text"></span></span>
                </div>
                <hr style='margin-top: 46px;'>
                <button type="button" class="agregar_producto_compra btn btn-outline-primary float-right"><i
...
<script> 
  ...
  function fecha_actual_compra_ntf() {
    ...
    document.getElementById("fecha_compra_c").value =
      ano + "-" + mes + "-" + dia;
  }
