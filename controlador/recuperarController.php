<?php
    ...
    if ($_POST['funcion'] == 'recuperar') {
        ...
        try {
            ...
            $mail->Password   = 'ingenieriadesistemas02';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
            $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
        
            //Recipients
            $mail->setFrom('antony_hernandez_olazabal@hotmail.com', 'Sistema administrativo');
            $mail->addAddress($email, 'Área de desarrollo de sistemas');     //Add a recipient
                              ...
                              <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                                <tr>
                                  <td style="width:130px;background:#D84A38;">
                                    <div>
                                    <a href="http://localhost/Sistemas/Sistema_farmacia/acceso"
