$(document).ready(function(){
    ...
    function mostrar_consultas(){
        ...
        $.post('controlador/VentaController.php',{funcion},(response)=>{
            ...
            $("#venta_dia_vendedor").html('S/'+(vistas.venta_dia_vendedor*1).toFixed(2));
            ...
            $("#id_ganancia_mensual").html('S/'+(vistas.ganancia_mensual*1).toFixed(2));
        })
    }
        ...
        datatable = $('#tabla_venta').DataTable( {
            ...
            "columns": [
                ...
                { "defaultContent": `<button class="imprimir_venta btn btn-secondary"><i class="fas fa-print"></i></button>
                                    ...
                                    <button class="borrar_venta btn btn-danger"><i class="fas fa-window-close"></i></button>`}/*Ya no es un dato que me trae datatable,es un elemento que será agregado por defecto */
            ],
            "destroy":true,
            "language": espanol
        });
    ...
    $("#tabla_venta tbody").on("click",'.ver',function(){
        ...
        fecha_registro = dias[date.getDay()-1] + " " + date.getDate() + " de " + meses[date.getMonth()] + " de " + date.getFullYear();
